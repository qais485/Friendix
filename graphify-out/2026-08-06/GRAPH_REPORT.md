...
## Corpus Check
- 413 files · ~176,913 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5832 nodes · 13335 edges · 315 communities (264 shown, 51 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 544 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `86354de1`
...
## Communities (315 total, 51 thin omitted)
...
Cohesion: 0.06
Nodes (70): useFriends(), CallModal(), CallModalProps, CallState, ChatHeader(), ChatHeaderProps, formatLastSeen(), ChatList() (+62 more)
...
Cohesion: 0.12
Nodes (26): RelationshipButton(), useAnalyticsOverview(), PostCardProps, PostModalProps, EditProfileModal(), ProfileHeader(), InfoItemProps, ProfileInfo() (+18 more)

### Community 9 - "CreatePostForm.tsx"
Cohesion: 0.07
Nodes (35): Switch, SwitchProps, BackgroundPicker(), BackgroundPickerProps, getPostBackgroundStyle(), POST_BACKGROUNDS, POST_BG_TEMPLATES, PostBackground (+27 more)
...
Cohesion: 0.11
Nodes (25): RightSidebar(), ToastContainer(), EventAttendeeItem(), useRelationshipSummary(), useSendFriendRequest(), GroupMemberItem(), GoLiveButton(), EMOJI_OPTIONS (+17 more)

### Community 14 - "friends/hooks.ts"
Cohesion: 0.14
Nodes (44): UserActionMenu(), UserActionMenuProps, FollowList(), cn(), FriendList(), FriendRequestCard(), FriendSuggestions(), FriendsPage() (+36 more)
...
Cohesion: 0.14
Nodes (28): BlockMuteList(), BlockMuteListProps, PrivacySection(), PrivacySectionProps, PrivacyToggle(), UserSearch(), useBlockedUsers(), useBlockUser() (+20 more)
...
Cohesion: 0.08
Nodes (39): RelationshipButtonProps, FollowListProps, NotificationBell(), NotificationDropdown(), NotificationDropdownProps, getNotificationRoute(), getNotificationText(), NotificationItem() (+31 more)
...
Cohesion: 0.04
Nodes (93): NAV_ITEMS, LiquidGlassFilter(), ParsedContent(), ParsedContentProps, Avatar, AVATAR_SIZE_PX, AvatarGroup, AvatarProps (+85 more)
...
Cohesion: 0.03
Nodes (108): StoriesRow(), CreateReel(), CreateReelProps, Privacy, PRIVACY_OPTIONS, ImageEditor(), MediaCard(), MediaCardProps (+100 more)
...
Cohesion: 0.12
Nodes (18): EmptyFeedProps, FEED_CONFIG, FeedTabsProps, feedApi, FEED_SORT_OPTIONS, FEED_TABS, FeedFilters, FeedPosition (+10 more)
...
Cohesion: 0.13
Nodes (43): InputDialog(), InputDialogProps, CreatePostButton(), EmptyFeed(), FeedFilters(), FeedTabs(), PostCard, PostModal() (+35 more)

### Community 43 - "useAuthStore"
Cohesion: 0.04
Nodes (60): App(), ProtectedRoute(), PublicRoute(), SetupUsernameRoute(), NotFoundPage(), Input, InputProps, Label (+52 more)
...
Cohesion: 0.12
Nodes (12): Comment, Post, SavedSearch, SearchHistory, datetime, Comment, LiveStream, Post (+4 more)
...
Cohesion: 0.10
Nodes (12): AuditLog, get_public_settings(), get, Public appearance settings consumed by the client app (category "appearance")., AdminRepository, User, UUID, BannedUser (+4 more)
...
### Community 107 - "AppLayout.tsx"
Cohesion: 0.22
Nodes (9): AppLayout(), AppLayoutProps, LayoutContext, LayoutContextType, useLayout(), FloatingActions(), BOTTOM_NAV_ITEMS, MobileBottomNav() (+1 more)
...
### Community 119 - "cloudinaryTransform.ts"
Cohesion: 0.06
Nodes (51): AdaptiveImageProps, ConfirmationDialog(), ConfirmationDialogProps, EventAttendees(), EventAttendeesProps, EventCard(), EventCardProps, EventChat() (+43 more)
...
### Community 125 - ".get_home_feed"
Cohesion: 0.27
Nodes (4): parse_cursor(), parse_trending_cursor(), Decode a feed keyset cursor into (is_pinned, created_at, post_id). Falls back…, Decode a trending keyset cursor into (trending_score, created_at, post_id).
...
Cohesion: 0.05
Nodes (32): ErrorBannerProps, ErrorState(), ErrorStateProps, AnalyticsCardSkeleton(), PostSkeleton(), AnalyticsPage(), periodOptions, Tab (+24 more)
...
Cohesion: 0.09
Nodes (35): useSearchHashtags(), AdvancedFilters(), AdvancedFiltersProps, CommentSearchResults(), CommentSearchResultsProps, LiveSearchResults(), LiveSearchResultsProps, PostSearchResults() (+27 more)
...
Cohesion: 0.07
Nodes (37): LiveChat(), LiveChatProps, LiveDonations(), LiveDonationsProps, LiveStreamPlayer(), LiveStreamPlayerProps, useChatMessages(), useDonations() (+29 more)
...
### Community 159 - "LiveGuestResponse"
Cohesion: 0.15
...
### Community 201 - "useScrollRestoration"
Cohesion: 0.83
...
- **Why does `User` connect `User` to `NotificationRepository`, `permissions.py`, `MessagingService`, `RelationshipRepository`, `GroupRepository`, `CommentService`, `models/__init__.py`, `FeedRepository`, `ProfileRepository`, `MessagingRepository`, `LiveRepository`, `AnalyticsRepository`, `HashtagService`, `FriendsRepository`, `base.py`, `NotificationService`, `EventService`, `relationship_service.py`, `PrivacyRepository`, `VideoRepository`, `SearchRepository`, `AdminRepository`, `RelationshipService`, `messaging_websocket`, `PermissionsService`, `AdminService`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `ProfileRepository` connect `ProfileRepository` to `LiveService`, `FeedService`, `GroupService`, `SearchRepository`, `EventService`, `RelationshipService`, `HashtagService`, `PrivacyService`, `LiveRepository`, `video_service.py`, `User`, `schemas/__init__.py`, `PrivacyRepository`, `SearchService`, `VideoService`, `FriendsService`, `relationship_service.py`, `ProfileService`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `Friendship` connect `models/__init__.py` to `LiveService`, `MessagingService`, `RelationshipRepository`, `MediaRepository`, `v1/media.py`, `CommentService`, `FeedRepository`, `MessagingRepository`, `LiveRepository`, `AnalyticsRepository`, `FriendsService`, `FriendsRepository`, `relationship_service.py`, `VideoRepository`, `SearchRepository`, `AdminRepository`, `RelationshipService`, `schemas/__init__.py`, `PermissionsService`?**
